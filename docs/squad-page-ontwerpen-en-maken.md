...
1. Alle teamleden werken aan de hand van de breakdownschets dezelfde pagina uit in HTML. Geef de HTMl bestanden een andere naam, anders krijg je conflicen als je je code gaat _comitten_ en _pushen_. 
